...
<style type="text/css">
	...
	#optin input {
		...
		#optin input.name { background: #fff url("' . JEM_URL . '/images/name.png") no-repeat 10px center; padding-left: 35px }
		#optin input.myemail { background: #fff url("' . JEM_URL .'images/email.png") no-repeat 10px center; padding-left: 35px }
		#optin input[type="submit"] {
			background: #217b30 url("' . JEM_URL. '/images/green.png") repeat-x top;
...
<input type="submit" value="Get Discount" name="subscribe" id="" class="button">			
    ...
    <div class="clear"><img src="' . JEM_URL . '/images/lock.png">We respect your privacy and will never sell or rent your details</div>
    </div>
</form>
</div>
