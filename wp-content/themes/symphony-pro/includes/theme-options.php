...
if ( ! class_exists( 'SDS_Theme_Options' ) ) {
	...
	class SDS_Theme_Options {
		...
		function admin_init() {
			...
			// Show/Hide Elements
			add_settings_section( 'sds_theme_options_show_hide_elements_section', __( 'Show or Hide Elements', 'symphony' ), array( $this, 'sds_theme_options_show_hide_elements_section' ), 'sds-theme-options[general]' );
			...
			add_settings_field( 'sds_theme_options_hide_tagline_field', __( 'Show or Hide Site Tagline:', 'symphony' ), array( $this, 'sds_theme_options_hide_tagline_field' ), 'sds-theme-options[general]', 'sds_theme_options_show_hide_elements_section' );

			// Hide Archive Titles
			//add_settings_section( 'sds_theme_options_hide_archive_titles_section', __( 'Show/Hide Archive Titles', 'symphony' ), array( $this, 'sds_theme_options_hide_archive_titles_section' ), 'sds-theme-options[general]' );
			add_settings_field( 'sds_theme_options_hide_archive_titles_field', __( 'Show or Hide Archive Titles:', 'symphony' ), array( $this, 'sds_theme_options_hide_archive_titles_field' ), 'sds-theme-options[general]', 'sds_theme_options_show_hide_elements_section' );

			// Hide Post Meta
			//add_settings_section( 'sds_theme_options_hide_post_meta_section', __( 'Show/Hide Post Meta', 'symphony' ), array( $this, 'sds_theme_options_hide_post_meta_section' ), 'sds-theme-options[general]' );
			add_settings_field( 'sds_theme_options_hide_post_meta_field', __( 'Show or Hide Post Meta:', 'symphony' ), array( $this, 'sds_theme_options_hide_post_meta_field' ), 'sds-theme-options[general]', 'sds_theme_options_show_hide_elements_section' );

			// Hide Author Meta
			//add_settings_section( 'sds_theme_options_hide_author_meta_section', __( 'Show/Hide Author Details', 'symphony' ), array( $this, 'sds_theme_options_hide_author_meta_section' ), 'sds-theme-options[general]' );
			add_settings_field( 'sds_theme_options_hide_author_meta_field', __( 'Show or Hide Author Details:', 'symphony' ), array( $this, 'sds_theme_options_hide_author_meta_field' ), 'sds-theme-options[general]', 'sds_theme_options_show_hide_elements_section' );
			...
			// Featured Image Size
			add_settings_section( 'sds_theme_options_featured_image_size_section', __( 'Featured Image Size', 'symphony' ), array( $this, 'sds_theme_options_featured_image_size_section' ), 'sds-theme-options[general]' );
			add_settings_field( 'sds_theme_options_featured_image_size_field', __( 'Featured Image Size:', 'symphony' ), array( $this, 'sds_theme_options_featured_image_size_field' ), 'sds-theme-options[general]', 'sds_theme_options_featured_image_size_section' );


			// Footer Branding (Slug)
			add_settings_section( 'sds_theme_options_footer_branding_section', __( 'Footer Branding', 'symphony' ), array( $this, 'sds_theme_options_footer_branding_section' ), 'sds-theme-options[general]' );
			add_settings_field( 'sds_theme_options_footer_copyright_field', __( 'Footer Copyright:', 'symphony' ), array( $this, 'sds_theme_options_footer_copyright_field' ), 'sds-theme-options[general]', 'sds_theme_options_footer_branding_section' );
			add_settings_field( 'sds_theme_options_footer_branding_field', __( 'Footer Branding:', 'symphony' ), array( $this, 'sds_theme_options_footer_branding_field' ), 'sds-theme-options[general]', 'sds_theme_options_footer_branding_section' );

			// Hide Footer Branding (Slug)
			add_settings_field( 'sds_theme_options_hide_footer_branding_field', __( 'Show or Hide Footer Branding:', 'symphony' ), array( $this, 'sds_theme_options_hide_footer_branding_field' ), 'sds-theme-options[general]', 'sds_theme_options_footer_branding_section' );
			...
			// Custom Scripts
 			add_settings_section( 'sds_theme_options_custom_scripts_section', __( 'Custom Scripts', 'symphony' ), array( $this, 'sds_theme_options_custom_scripts_section' ), 'sds-theme-options[custom-scripts-styles]' );
			add_settings_field( 'sds_theme_options_custom_scripts_head_field', __( 'Head:', 'symphony' ), array( $this, 'sds_theme_options_custom_scripts_head_field' ), 'sds-theme-options[custom-scripts-styles]', 'sds_theme_options_custom_scripts_section' );
			add_settings_field( 'sds_theme_options_custom_scripts_footer_field', __( 'Footer:', 'symphony' ), array( $this, 'sds_theme_options_custom_scripts_footer_field' ), 'sds-theme-options[custom-scripts-styles]', 'sds_theme_options_custom_scripts_section' );

			// Custom Styles
			add_settings_section( 'sds_theme_options_custom_styles_section', __( 'Custom Styles', 'symphony' ), array( $this, 'sds_theme_options_custom_styles_section' ), 'sds-theme-options[custom-scripts-styles]' );
			add_settings_field( 'sds_theme_options_custom_styles_field', __( 'Custom CSS:', 'symphony' ), array( $this, 'sds_theme_options_custom_styles_field' ), 'sds-theme-options[custom-scripts-styles]', 'sds_theme_options_custom_styles_section' );
			...
			add_settings_section( 'sds_theme_options_license_section', __( 'License', 'symphony' ), array( $this, 'sds_theme_options_license_section' ), 'sds-theme-options[license]' );
			add_settings_field( 'sds_theme_options_license_key_field', __( 'License Key:', 'symphony' ), array( $this, 'sds_theme_options_license_key_field' ), 'sds-theme-options[license]', 'sds_theme_options_license_section' );
		}
		...
		?>
			<p><?php _e( 'Use this option to show or hide various elements on your site.', 'symphony' ); ?></p>
		<?php
		}
		...
		function sds_theme_options_hide_tagline_field() {
			global $sds_theme_options;
		?>
			<div class="checkbox sds-theme-options-checkbox checkbox-show-hide checkbox-show-hide-tagline" data-label-left="<?php esc_attr_e( 'Show', 'symphony' ); ?>" data-label-right="<?php esc_attr_e( 'Hide', 'symphony' ); ?>">
		...
		function sds_theme_options_hide_archive_titles_field() {
			global $sds_theme_options;
		?>
			<div class="checkbox sds-theme-options-checkbox checkbox-show-hide checkbox-show-hide-archive-titles" data-label-left="<?php esc_attr_e( 'Show', 'symphony' ); ?>" data-label-right="<?php esc_attr_e( 'Hide', 'symphony' ); ?>">
			...
			<span class="description"><?php _e( 'When "show" is displayed, the archive titles will be displayed on your site and vise-versa.', 'symphony' ); ?></span>
		<?php
		}
		...
		function sds_theme_options_hide_post_meta_field() {
			global $sds_theme_options;
		?>
			<div class="checkbox sds-theme-options-checkbox checkbox-show-hide checkbox-show-hide-post-meta" data-label-left="<?php esc_attr_e( 'Show', 'symphony' ); ?>" data-label-right="<?php esc_attr_e( 'Hide', 'symphony' ); ?>">
			...
			<span class="description"><?php _e( 'When "show" is displayed, the post meta will be displayed on your site and vise-versa.', 'symphony' ); ?></span>
		<?php
		}
		...
		function sds_theme_options_hide_author_meta_field() {
			global $sds_theme_options;
		?>
			<div class="checkbox sds-theme-options-checkbox checkbox-show-hide checkbox-show-hide-author-meta" data-label-left="<?php esc_attr_e( 'Show', 'symphony' ); ?>" data-label-right="<?php esc_attr_e( 'Hide', 'symphony' ); ?>">
			...
			<span class="description"><?php _e( 'When "show" is displayed, the author details will be displayed on your site and vise-versa.', 'symphony' ); ?></span>
		<?php
		}
		...
		?>
			<p><?php _e( 'Use this section to modify how featured images are displayed on your site.', 'symphony' ); ?></p>
		<?php
		}
						...
						<option value="<?php echo esc_attr( $size ); ?>" <?php selected( $featured_image_size, $size ); ?>>
							<?php
								...
								if ( $size === $default_featured_image_size )
									printf( _x( '%1$s %2$s (Default)', 'default featured image size label, %1$s is the image size name, %2$s is the image dimensions', 'symphony' ), $size, implode( 'x', $atts ) );
		...
		?>
			<p><?php _e( 'Use this section to modify the footer branding of your website. Entering a value here will over-write the default footer branding. You may use the following HTML tags: <code>&lt;a&gt;, &lt;strong&gt;, &lt;em&gt;, &lt;span&gt;</code>', 'symphony' ); ?></p>
		<?php
		}
		...
		function sds_theme_options_hide_footer_branding_field() {
			global $sds_theme_options;
		?>
			<div class="checkbox sds-theme-options-checkbox checkbox-show-hide checkbox-show-hide-footer-branding" data-label-left="<?php esc_attr_e( 'Show', 'symphony' ); ?>" data-label-right="<?php esc_attr_e( 'Hide', 'symphony' ); ?>">
			...
			<span class="description"><?php _e( 'When "show" is displayed, the footer branding will be displayed on your site and vise-versa.', 'symphony' ); ?></span>
		<?php
		}
		...
		function sds_theme_options_content_layout_global_field() {
			$this->content_layouts_field( 'global', __( 'Select a content layout that will be applied globally on your site. Select more specific content layouts below.', 'symphony' ) );
		}
		...
		function sds_theme_options_content_layout_front_page_field() {
			$this->content_layouts_field( 'front_page', __( 'Select a content layout that will be applied to the front page on your site (if selected in Settings > Reading).', 'symphony' ) );
		}
		...
		function sds_theme_options_content_layout_home_field() {
			$this->content_layouts_field( 'home', __( 'Select a content layout that will be applied to the blog on your site.', 'symphony' ) );
		}
		...
		function sds_theme_options_content_layout_single_field() {
			$this->content_layouts_field( 'single', __( 'Select a content layout that will be applied to single posts on your site.', 'symphony' ) );
		}
		...
		function sds_theme_options_content_layout_page_field() {
			$this->content_layouts_field( 'page', __( 'Select a content layout that will be applied to single pages on your site.', 'symphony' ) );
		}
		...
		function sds_theme_options_content_layout_archive_field() {
			$this->content_layouts_field( 'archive', __( 'Select a content layout that will be applied to archives on your site.', 'symphony' ) );
		}
		...
		function sds_theme_options_content_layout_category_field() {
			$this->content_layouts_field( 'category', __( 'Select a content layout that will be applied to category archives on your site.', 'symphony' ) );
		}
		...
		function sds_theme_options_content_layout_tag_field() {
			$this->content_layouts_field( 'tag', __( 'Select a content layout that will be applied to tag archives on your site.', 'symphony' ) );
		}
		...
		function sds_theme_options_content_layout_404_field() {
			$this->content_layouts_field( '404', __( 'Select a content layout that will be applied to the 404 error page on your site.', 'symphony' ) );
		}
		...
		function sds_theme_options_custom_scripts_section() { ?>
			<p><?php _e( 'Add custom scripts to either the head section or the footer section of your site. See <a href="http://codex.wordpress.org/Using_Javascript" target="_blank">WordPress Codex: Using Javascript</a> for more information.', 'symphony' ); ?></p>
		<?php
		}
		...
		function sds_theme_options_custom_styles_section() { ?>
			<p><?php _e( 'Add custom styles your site. See <a href="https://developer.mozilla.org/en/CSS" target="_blank">Mozilla Developer Network: CSS</a> for more information.', 'symphony' ); ?></p>
		<?php
		}
		...
		function sds_theme_options_license_section() { ?>
			<p><?php printf( __( 'Enter your license key below to continue to receive updates for %1$s.', 'symphony' ), $this->theme->get( 'Name' ) ); ?></p>
		<?php
		}
		...
		?>
			<div class="wrap about-wrap">
				...
				<div class="about-text sds-about-text"><?php _e( 'Customize your theme to the fullest extent by using the options below.', 'symphony' ); ?></div>
				...
				<h3 class="nav-tab-wrapper sds-theme-options-nav-tab-wrapper sds-theme-options-tab-wrap">
					...
					<a href="#custom-scripts-styles" id="custom-scripts-styles-tab" class="nav-tab sds-theme-options-tab"><?php _e( 'Custom Scripts/Styles', 'symphony' ); ?></a>
					<a href="#license" id="license-tab" class="nav-tab sds-theme-options-tab"><?php _e( 'License', 'symphony' ); ?></a>
				...
				<form method="post" action="options.php" enctype="multipart/form-data" id="sds-theme-options-form">
					...
					<div id="help-support-tab-content" class="sds-theme-options-tab-content">
						...
						<p><?php _e( 'If you\'d like to create a suppport ticket, please visit our <a href="http://slocumstudio.freshdesk.com" target="_blank">help desk</a>.', 'symphony' ); ?></p>

						<h3><?php _e( 'WordPress Snapshot', 'symphony' ); ?></h3>

						<p><?php printf( __( 'The following information can be helpful to us when an issue with %1$s may arise. If a support tech requests a "snapshot", please send us this information by copying and pasting it into the support ticket.', 'symphony' ), $this->theme->get( 'Name' ) ); ?></p>
		...
		function get_available_image_size_choices() {
			...
			foreach ( $this->get_available_image_sizes() as $size => $atts ) {
				...
				// Default featured image size
				if ( $size === $default_featured_image_size )
					$avail_image_size_choices[$size] = sprintf( _x( '%1$s %2$s (Default)', 'default featured image size label, %1$s is the image size name, %2$s is the image dimensions', 'symphony' ), $size, implode( 'x', $atts ) );
				// Other featured image sizes
				else
		...
		public static function get_snapshot_details() {
			...
			$snapshot = array(
				// Browser
				'browser_info' => array(
					'label' => __( 'Browser Info:', 'symphony' ),
					'value' => ''
				),
				/*'browser' => array(
					'label' => __( 'Browser:', 'symphony' ),
					'value' => $browser['browser']
				),
				'browser_version' => array(
					'label' => __( 'Browser Version:', 'symphony' ),
					'value' => $browser['version']
				),
				'browser_platform' => array(
					'label' => __( 'Platform (Operating System):', 'symphony' ),
					'value' => $browser['platform']
				),*/
				'browser_user_agent' => array(
					'label' => __( 'User Agent:', 'symphony' ),
					'value' => $_SERVER['HTTP_USER_AGENT']
				),
				// Theme
				'theme' => array(
					'label' => __( 'Theme:', 'symphony' ),
					'value' => $theme_data->Name . ' ' . $theme_data->Version
				),
				// Other
				'front_page' => array(
					'label' => __( 'Front Page:', 'symphony' ),
					'value' => $front_page ? get_the_title( $front_page ).' (ID# '.$front_page.')'.'' : __( 'n/a', 'symphony' )
				),
				'page_for_posts' => array(
					'label' => __( 'Page for Posts:', 'symphony' ),
					'value' => $front_page ? get_the_title( $page_for_posts ).' (ID# '.$page_for_posts.')'.'' : __( 'n/a', 'symphony' )
				),
				'display_errors' => array(
					'label' => __( 'Display Errors:', 'symphony' ),
					'value' => ini_get( 'display_errors' ) != false ? __( 'On', 'symphony' ) : __( 'Off', 'symphony' )
				),
				'jquery_version' => array(
					'label' => __( 'jQuery Version:', 'symphony' ),
					'value' => wp_script_is( 'jquery', 'registered' ) ? $GLOBALS['wp_scripts']->registered['jquery']->ver : __( 'n/a', 'symphony' )
				),
				'php_session' => array(
					'label' => __( 'PHP Session:', 'symphony' ),
					'value' => isset( $_SESSION ) ? __( 'Enabled', 'symphony' ) : __( 'Disabled', 'symphony' )
				),
				'php_cookies' => array(
					'label' => __( 'Use Cookies:', 'symphony' ),
					'value' => ini_get( 'session.use_cookies' ) ? __( 'On', 'symphony' ) : __( 'Off', 'symphony' )
				),
				'php_cookies_only' => array(
					'label' => __( 'Use Cookies Only:', 'symphony' ),
					'value' => ini_get( 'session.use_only_cookies' ) ? __( 'On', 'symphony' ) : __( 'Off', 'symphony' )
				),
				'php_fsockopen' => array(
					'label' => __( 'fsockopen() Support:', 'symphony' ),
					'value' => function_exists( 'fsockopen' ) ? __( 'Your server supports fsockopen.', 'symphony' ) : __( 'Your server does not support fsockopen.', 'symphony' )
				),
				'php_curl' => array(
					'label' => __( 'cURL Support:', 'symphony' ),
					'value' => function_exists( 'curl_init' ) ? __( 'Your server supports cURL.', 'symphony' ) : __( 'Your server does not support cURL.', 'symphony' )
				),
				'php_soap_client' => array(
					'label' => __( 'SOAP Client Support:', 'symphony' ),
					'value' => class_exists( 'SoapClient' ) ? __( 'Your server has the SOAP Client enabled.', 'symphony' ) : __( 'Your server does not have the SOAP Client enabled.', 'symphony' )
				),
				'php_suhosin' => array(
					'label' => __( 'SUHOSIN Support:', 'symphony' ),
					'value' => extension_loaded( 'suhosin' ) ? __( 'Your server has SUHOSIN installed.', 'symphony' ) : __( 'Your server does not have SUHOSIN installed.', 'symphony' )
				),
				'php_open_ssl' => array(
					'label' => __( 'OpenSSL Support:', 'symphony' ),
					'value' => extension_loaded('openssl') ? __( 'Your server has OpenSSL installed.', 'symphony' ) : __( 'Your server does not have OpenSSL installed.', 'symphony' )
				),
				'php_version' => array(
					'label' => __( 'PHP Version:', 'symphony' ),
					'value' => PHP_VERSION
				),
				'mysql_version' => array(
					'label' => __( 'MySQL Version:', 'symphony' ),
					'value' => $wpdb->db_version()
				),
				'server_software' => array(
					'label' => __( 'Server Software:', 'symphony' ),
					'value' => $_SERVER['SERVER_SOFTWARE']
				),
				'php_memory_limit' => array(
					'label' => __( 'PHP Memory Limit:', 'symphony' ),
					'value' => ini_get( 'memory_limit' )
				),
				'php_upload_max_size' => array(
					'label' => __( 'PHP Maximum Upload Size:', 'symphony' ),
					'value' => ini_get( 'upload_max_filesize' )
				),
				'php_post_max_size' => array(
					'label' => __( 'PHP Maximum Post Size:', 'symphony' ),
					'value' => ini_get( 'post_max_size' )
				),
				'php_max_execution_time' => array(
					'label' => __( 'PHP Maximum Execution Time:', 'symphony' ),
					'value' => ini_get( 'max_execution_time' )
				),
				'php_max_input_vars' => array(
					'label' => __( 'PHP Maximum Input Variables:', 'symphony' ),
					'value' => ini_get( 'max_input_vars' )
				),
				'php_session_name' => array(
					'label' => __( 'PHP Session Name:', 'symphony' ),
					'value' => esc_html( ini_get( 'session.name' ) )
				),
				'php_cookie_path' => array(
					'label' => __( 'PHP Cookie Path:', 'symphony' ),
					'value' => esc_html( ini_get( 'session.cookie_path' ) )
				),
				'php_save_path' => array(
					'label' => __( 'PHP Save Path:', 'symphony' ),
					'value' => esc_html( ini_get( 'session.save_path' ) )
				),
				// WordPress
				'wp_site_url' => array(
					'label' => __( 'Site URL:', 'symphony' ),
					'value' => site_url()
				),
				'wp_home_url' => array(
					'label' => __( 'Home URL:', 'symphony' ),
					'value' => home_url()
				),
				'wp_version' => array(
					'label' => __( 'WordPress Version:', 'symphony' ),
					'value' => get_bloginfo( 'version' )
				),
				'wp_permalink_structure' => array(
					'label' => __( 'Permalink Structure:', 'symphony' ),
					'value' => get_option( 'permalink_structure' )
				),
				'wp_post_types' => array(
					'label' => __( 'Post Types:', 'symphony' ),
					'value' => implode( ', ', get_post_types( '', 'names' ) )
				),
				'wp_post_stati' => array(
					'label' => __( 'Post Stati:', 'symphony' ),
					'value' => implode( ', ', get_post_stati() )
				),
				'wp_user_count' => array(
					'label' => __( 'User Count:', 'symphony' ),
					'value' => count( get_users() )
				),
				'wp_memory_limit' => array(
					'label' => __( 'Memory Limit:', 'symphony' ),
					'value' => WP_MEMORY_LIMIT
				),
				'wp_prefix' => array(
					'label' => __( 'Database Prefix:', 'symphony' ),
					'value' => $wpdb->base_prefix
				),
				'wp_prefix_length' => array(
					'label' => __( 'Prefix Length:', 'symphony' ),
					'value' => strlen( $wpdb->prefix ) < 16 ? __( 'Acceptable', 'symphony' ) : __( 'Too Long', 'symphony' )
				),
				'wp_is_multisite' => array(
					'label' => __( 'Multisite:', 'symphony' ),
					'value' => is_multisite() ? __( 'Yes', 'symphony' ) : __( 'No', 'symphony' )
				),
				'wp_is_safe_mode' => array(
					'label' => __( 'Safe Mode:', 'symphony' ),
					'value' => is_multisite() ? __( 'Yes', 'symphony' ) : __( 'No', 'symphony' )
				),
				'wp_is_wp_debug' => array(
					'label' => __( 'WP DEBUG:', 'symphony' ),
					'value' => defined( 'WP_DEBUG' ) ? WP_DEBUG ? __( 'Enabled', 'symphony' ) : __( 'Disabled', 'symphony' ) : __( 'Not Set', 'symphony' )
				)
			);

			if ( is_multisite() ) {
				$snapshot['wp_multisite_total'] = array(
					'label' => __( 'Total Sites:', 'symphony' ),
					'value' => get_blog_count()
				);

				$snapshot['wp_multisite_base'] = array(
					'label' => __( 'Base Site:', 'symphony' ),
					'value' => $ms_sites[0]['domain']
				);

				$snapshot['wp_multisite_all'] = array(
					'label' => __( 'All Sites:', 'symphony' ),
					'value' => ''
				);
				...
				foreach ( $ms_sites as $site_index => $site )
					if ( $site['path'] != '/' )
						$snapshot['wp_multisite_all_' . $site_index] =array(
							'label' => sprintf( __( 'Site %1$s:', 'symphony' ), $site_index ),
			...
			if ( $plugins && $mu_plugins )
				$snapshot['wp_total_plugin_count'] = array(
					'label' => __( 'Total Plugins:', 'symphony' ),
			...
			if ( $mu_plugins ) {
				$snapshot['wp_must_use_plugins'] = array(
					'label' => __( 'Must-Use Plugins:', 'symphony' ),
					'value' => ''
				);
			...
			if ( is_multisite() ) {
				$snapshot['wp_multisite_network_active'] = array(
					'label' => sprintf( __( 'Network Active Plugins (%1$s):', 'symphony' ), count( $nt_plugins ) ),
					'value' => ''
				);
			...
			if ( $plugins ) {
				$snapshot['wp_active_plugins'] = array(
					'label' => sprintf( __( 'Active Plugins (%1$s):', 'symphony' ), count( $active_plugins ) ),
					'value' => ''
				);
			...
			if ( $plugins ) {
				$snapshot['wp_inactive_plugins'] = array(
					'label' => sprintf( __( 'Inactive Plugins (%1$s):', 'symphony' ), ( count( $plugins ) - count( $active_plugins ) ) ),
					'value' => ''
				);
