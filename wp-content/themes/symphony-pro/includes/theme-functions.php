		...
		<div class="sds-sitemap sitemap">
			<?php if ( apply_filters( 'sds_sitemap_show_pages', true ) ) : // Allow pages to not be displayed ?>
				<div class="sitemap-pages page-list">
					<h2 title="<?php esc_attr_e( 'Pages', 'symphony' ); ?>"><?php _e( 'Pages', 'symphony' ); ?></h2>
					<ul>
			...
			<?php if ( apply_filters( 'sds_sitemap_show_monthly_archives', true ) ) : // Allow monthly archives to not be displayed ?>
				<div class="sitemap-archives sitemap-monthly-archives monthly-archives archive-list">
					<h2 title="<?php esc_attr_e( 'Monthly Archives', 'symphony' ); ?>"><?php _e( 'Monthly Archives', 'symphony' ); ?></h2>
					<ul>
			...
			<?php if ( apply_filters( 'sds_sitemap_show_categories', true ) ) : // Allow categories to not be displayed ?>
				<div class="sitemap-categories category-list">
					<h2 title="<?php esc_attr_e( 'Blog Categories', 'symphony' ); ?>"><?php _e( 'Blog Categories', 'symphony' ); ?></h2>
					<ul>
...
if ( ! function_exists( 'sds_archive_title' ) ) {
	function sds_archive_title() {
		...
		// Otherwise use fallback functionality TODO: Remove
			...
			?>
				<h1 title="<?php esc_attr_e( 'Author Archive:', 'symphony' ); ?> <?php echo ( $author instanceof WP_User ) ? $author->display_name : false; ?>" class="page-title author-archive-title">
					<?php _e( 'Author Archive:', 'symphony' ); ?> <?php echo ( $author instanceof WP_User ) ? $author->display_name : false; ?>
				</h1>
			<?php
			// Categories
			elseif ( is_category() ) :
			?>
				<h1 title="<?php single_cat_title( __( 'Category Archive: ', 'symphony' ) ); ?>" class="page-title category-archive-title">
					<?php single_cat_title( __( 'Category Archive: ', 'symphony' ) ); ?>
				</h1>
			<?php
			// Tags
			elseif ( is_tag() ) :
			?>
				<h1 title="<?php single_tag_title( __( 'Tag Archive: ', 'symphony' ) ); ?>" class="page-title tag-archive-title">
					<?php single_tag_title( __( 'Tag Archive: ', 'symphony' ) ); ?>
				</h1>
			<?php
			// Daily Archives
			elseif ( is_day() ) :
			...
			?>
				<h1 title="<?php esc_attr_e( 'Daily Archives:', 'symphony' ); ?> <?php echo $the_date; ?>" class="page-title day-archive-title daily-archive-title">
					<?php _e( 'Daily Archives:', 'symphony' ); ?> <?php echo $the_date; ?>
				</h1>
			<?php
			// Monthly Archives
			elseif ( is_month() ) :
			...
			?>
				<h1 title="<?php esc_attr_e( 'Monthly Archives:', 'symphony' ); ?> <?php echo $the_date; ?>" class="page-title month-archive-title monthly-archive-title">
					<?php _e( 'Monthly Archives:', 'symphony' ); ?> <?php echo $the_date; ?>
				</h1>
			<?php
			// Yearly Archives
			elseif ( is_year() ) :
			...
			?>
				<h1 title="<?php esc_attr_e( 'Yearly Archives:', 'symphony' ); ?> <?php echo $the_date; ?>" class="page-title year-archive-title yearly-archive-title">
					<?php _e( 'Yearly Archives:', 'symphony' ); ?> <?php echo $the_date; ?>
				</h1>
			<?php
			endif;
		endif;
...
if ( ! function_exists( 'sds_no_posts' ) ) {
	...
	?>
		<section class="no-results no-posts">
			<p><?php _e( 'We were not able to find any posts. Please try again.', 'symphony' ); ?></p>
		</section>
	<?php
	}
}
...
if ( ! function_exists( 'sds_comment' ) ) {
	function sds_comment( $comment, $args, $depth ) {
		...
		<li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
			<p><?php _e( 'Pingback:', 'symphony' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( 'Edit', '<span class="ping-meta"><span class="edit-link">', '</span></span>' ); ?></p>
		</li>
		<?php
			break;
			default :
			...
			<article id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
				<section class="comment-author vcard">
					<section class="author-details">
						...
						<header class="comment-meta">
							<cite class="fn">
								<?php
									printf( __( '<a href="%1$s"><time datetime="%2$s" itemprop="commentTime">%3$s</time></a>', 'symphony' ),
										esc_url( get_comment_link( $comment->comment_ID ) ),
										get_comment_time( 'c' ),
										sprintf( __( '%1$s at %2$s', 'symphony' ), get_comment_date(), get_comment_time() )
									);
								?>

								<?php edit_comment_link( __( 'Edit', 'symphony' ), '<span class="edit-link">', '<span>' ); ?>
							</cite>
						</header>
					</section>
				</section>
				...
				<section class="comment-content-container">
					<?php if ( $comment->comment_approved == '0' ) : ?>
						<p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'symphony' ); ?></p>
					<?php endif; ?>
				...
				<section class="reply">
					<?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Reply', 'symphony' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
				</section>
			</article>
		</li>
		<?php
...
function sds_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section( 'title_tagline' )->title = __( 'Logo/Site Title & Tagline', 'symphony' );
	...
	$wp_customize->add_section( 'sds_theme_options_show_hide', array(
		...
		'description' => __( 'Use these options to show or hide various elements on your site.', 'symphony' )
	) );
	...
	$wp_customize->add_control(
		new SDS_Theme_Options_Customize_Checkbox_Control(
			...
			'sds_theme_options[footer][hide_branding]', // IDs can have nested array keys
			array(
				'label' => __( 'Footer Copyright &amp; Branding', 'symphony' ),
				'section'  => 'sds_theme_options_show_hide',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'primary_color',
			array(
				'label' => __( 'Primary Theme Color', 'symphony' ),
				'section' => 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			array(
				...
				'description' => __( 'Use this section to modify how featured images are displayed on your site.', 'symphony' ),
				'section'  => 'images',
	...
	$wp_customize->add_panel( 'sds_theme_options_custom_scripts_styles', array(
		...
		'title' => __( 'Custom Scripts &amp; Styles', 'symphony' )
	) );
	...
	$wp_customize->add_section( 'sds_theme_options_custom_scripts', array(
		'priority' => 10,
		'title' => __( 'Custom Scripts', 'symphony' ),
		'description' => sprintf( __( 'Add custom scripts to either the head section or the footer section of your site. See <a href="%1$s" target="_blank">WordPress Codex: Using Javascript</a> for more information.', 'symphony' ), esc_url( 'http://codex.wordpress.org/Using_Javascript' ) ),
	...
	$wp_customize->add_control(
		new SDS_Theme_Options_Customize_Textarea_Control(
			...
			'sds_theme_options[custom_scripts][wp_head]', // IDs can have nested array keys
			array(
				'label' => _x( 'Head', 'Custom scripts for wp_head label', 'symphony' ),
	...
	$wp_customize->add_control(
		new SDS_Theme_Options_Customize_Textarea_Control(
			...
			'sds_theme_options[custom_scripts][wp_footer]', // IDs can have nested array keys
			array(
				'label' => _x( 'Footer', 'Custom scripts for wp_footer label', 'symphony' ),
				'section'  => 'sds_theme_options_custom_scripts',
	...
	$wp_customize->add_section( 'sds_theme_options_custom_styles', array(
		'priority' => 20,
		'title' => __( 'Custom Styles', 'symphony' ),
		'description' => sprintf( __( 'Add custom styles your site. See <a href="%1$s" target="_blank">Mozilla Developer Network: CSS</a> for more information.', 'symphony' ), esc_url( 'https://developer.mozilla.org/en-US/docs/Web/CSS' ) ),
		'panel' => 'sds_theme_options_custom_scripts_styles'
	) );
	...
	$wp_customize->add_control(
		new SDS_Theme_Options_Customize_Textarea_Control(
			...
			'sds_theme_options[custom_styles]', // IDs can have nested array keys
			array(
				'label' => _x( 'CSS', 'Custom styles label', 'symphony' ),
	...
	$wp_customize->add_section( 'sds_footer_copyright_branding', array(
		...
		'title' => __( 'Copyright &amp; Branding', 'symphony' ),
		'description' => __( 'Use this section to modify the footer branding of your website. Entering a value here will over-write the default footer branding. You may use the following HTML tags: <code>&lt;a&gt;, &lt;strong&gt;, &lt;em&gt;, &lt;span&gt;</code>', 'symphony' )
	) );
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			array(
				'label' => __( 'Footer Copyright', 'symphony' ),
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'sds_theme_options[footer][branding]', // IDs can have nested array keys
			array(
				'label' => __( 'Footer Branding', 'symphony' ),
				'section' => 'sds_footer_copyright_branding',
	...
	if ( isset( $sds_theme_options['license'] ) && isset( $sds_theme_options['license']['key'] ) && ! empty( $sds_theme_options['license']['key'] ) ) {
		...
		if ( ! is_wp_error( $response ) && ( $license_data = json_decode( wp_remote_retrieve_body( $response ) ) ) )
			...
			if ( $license_data->success && $license_data->license === 'valid' )
				...
				$sds_theme_options['license']['status'] = 'invalid';
...
function sds_after_setup_theme() {
	...
	register_nav_menus( array(
		'top_nav' => __( 'Top Navigation', 'symphony' ),
		'primary_nav' => __( 'Primary Navigation', 'symphony' ),
		'footer_nav' => __( 'Footer Navigation', 'symphony' )
	) );
}
...
function sds_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Primary Sidebar', 'symphony' ),
		'id'            => 'primary-sidebar',
		'description'   => __( 'This widget area is the primary widget area.', 'symphony' ),
	...
	// Secondary sidebar
	register_sidebar( array(
		'name'          => __( 'Secondary Sidebar', 'symphony' ),
		'id'            => 'secondary-sidebar',
		'description'   => __( 'This widget area is the secondary widget area.', 'symphony' ),
	...
	// After Posts
	register_sidebar( array(
		'name'          => __( 'After Posts', 'symphony' ),
		'id'            => 'after-posts-sidebar',
		'description'   => __( 'This widget area is displayed below the content on single posts only.', 'symphony' ),
	...
	// Footer
	register_sidebar( array(
		'name'          => __( 'Footer', 'symphony' ),
		'id'            => 'footer-sidebar',
		'description'   => __( 'This widget area is displayed in the footer of all pages.', 'symphony' ),
	...
	// Copyright
	register_sidebar( array(
		'name'          => __( 'Copyright Area', 'symphony' ),
		'id'            => 'copyright-area-sidebar',
		'description'   => __( 'This widget area is designed for small text blurbs or disclaimers at the bottom of the website.', 'symphony' ),
...
function sds_get_copyright() {
	return apply_filters( 'sds_copyright', sprintf( wp_kses( __( 'Copyright &copy; %1$s <a href="%2$s">%3$s</a>. All Rights Reserved.', 'symphony' ), array( 'a' => array( 'href' => array() ) ) ), date( 'Y' ), esc_url( home_url( '/' ) ), get_bloginfo( 'name' ) ) );
}
...
function sds_get_copyright_branding() {
	...
	return apply_filters( 'sds_copyright_branding', sprintf( __( '<a href="%1$s" target="_blank">%2$s by Slocum Studio</a>', 'symphony' ), esc_url( sprintf( 'http://slocumthemes.com/?utm_source=%1$s&amp;utm_medium=footer-plugs&amp;utm_campaign=WordPressThemes', esc_url( home_url( '/' ) ) ) ), $sds_theme->get( 'Name' ) ), $sds_theme->get( 'Name' ), $sds_theme );
}
